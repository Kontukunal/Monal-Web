          ...
          {projects.map((p, i) => {
            return (
              ...
              >
                ...
                <div className="absolute inset-0 rounded-[22px] ring-0 ring-white/70 group-hover:ring-2 transition-all duration-500 pointer-events-none" />
                <div className="absolute inset-x-0 bottom-0 p-5 flex items-end justify-between gap-3 translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  ...
                  <span className="shrink-0 w-9 h-9 grid place-items-center rounded-full bg-paper text-ink">
